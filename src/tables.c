...
const   struct  material_type    material_table[] =
{
    ...
    // ozgul agirlik. 1 cm3'ün agirligi
    {"adamantite"   ,0 ,0 ,7 ,3, 4 ,0},
    {"air"          ,0 ,0 ,0 ,9, 9 ,0},
    {"aluminum"     ,0 ,0 ,4 ,5, 5 ,0},
    {"amethyst"     ,0 ,0 ,6 ,3, 4 ,0},
    {"ash"          ,0 ,0 ,1 ,6, 9 ,0},
    {"bamboo"       ,0 ,4 ,2 ,4, 8 ,0},
    {"bearskin"     ,0 ,8 ,6 ,7, 8 ,0},
    {"bone"         ,3 ,0 ,6 ,4, 5 ,9},
    {"brass"        ,0 ,0 ,7 ,3, 4 ,0},
    {"bronze"       ,0 ,0 ,7 ,3, 4 ,0},
    {"cashmire"     ,0 ,7 ,3 ,8, 9 ,0},
    {"clay"         ,0 ,0 ,1 ,5, 7 ,0},
    {"coal"         ,0 ,0 ,1 ,5, 4 ,0},
    {"copper"       ,0 ,0 ,5 ,4, 4 ,0},
    {"coral"        ,0 ,0 ,3 ,5, 6 ,0},//mercan
    {"corundum"     ,0 ,0 ,9 ,2, 4 ,0},//elmastan cok en sert maddelerden
    {"cotton"       ,0 ,7 ,2 ,8, 9 ,0},
    {"crystal"      ,0 ,0 ,5 ,3, 4 ,0},
    {"diamond"      ,0 ,0 ,9 ,3, 3 ,0},
    {"dragonskin"   ,0 ,9 ,9 ,9, 9 ,0},
    {"ebony"        ,0 ,0 ,8 ,2, 6 ,0},
    {"emerald"      ,0 ,0 ,7 ,3, 6 ,0},
    {"energy"       ,0 ,0 ,0 ,9, 9 ,9},
    {"feather"      ,0 ,4 ,1 ,8, 9 ,0},
    {"felt"         ,0 ,8 ,5 ,7, 9 ,0},//kece
    {"fiber"        ,0 ,5 ,5 ,5, 9 ,0},
    {"fish"         ,9 ,0 ,0 ,3, 8 ,0},
    {"fishskin"     ,4 ,3 ,4 ,8, 9 ,0},
    {"flesh"        ,2 ,0 ,0 ,7, 6 ,0},
    {"flower"       ,5 ,0 ,0 ,6, 8 ,0},
    {"fur"          ,1 ,6 ,4 ,7, 9 ,0},
    {"gem"          ,0 ,0 ,6 ,4, 4 ,0},
    ...
    {"meat"         ,9 ,0 ,0 ,8, 4 ,0},
    {"mithril"      ,0 ,0 ,9 ,9, 4 ,0},
    {"nothingness"  ,0 ,0 ,0 ,9, 9 ,9},
    {"oak"          ,0 ,0 ,2 ,4, 9 ,9},
    {"obsidian"     ,0 ,0 ,6 ,3, 2 ,0},
    {"oil"          ,0 ,0 ,0 ,7, 9 ,0},
    {"onyx"         ,0 ,0 ,5 ,4, 4 ,0},
    {"opal"         ,0 ,0 ,6 ,4, 5 ,0},
    {"paper"        ,0 ,0 ,0 ,5, 9 ,0},
    {"parafin"      ,0 ,0 ,0 ,7, 9 ,0},
    {"parchment"    ,0 ,0 ,0 ,5, 9 ,0},
    {"pearl"        ,0 ,0 ,7 ,4, 4 ,0},
    {"plastic"      ,0 ,5 ,2 ,6, 9 ,0},
    {"platinum"     ,0 ,0 ,9 ,3, 3 ,0},
    {"porcelain"    ,0 ,0 ,5 ,3, 4 ,0},
    {"quartz"       ,0 ,0 ,8 ,3, 4 ,0},
    {"rubber"       ,0 ,6 ,3 ,7, 9 ,0},
    {"ruby"         ,0 ,0 ,7 ,4, 3 ,0},
    {"sandstone"    ,0 ,0 ,3 ,6, 6 ,0},
    {"sapphire"     ,0 ,0 ,5 ,4, 3 ,0},
    {"satin"        ,0 ,6 ,2 ,8, 9 ,0},
    {"silk"         ,0 ,6 ,2 ,8, 9 ,0},
    {"silver"       ,0 ,0 ,6 ,3, 4 ,0},
    {"skin"         ,2 ,7 ,4 ,8, 9 ,0},
    {"snakeskin"    ,2 ,7 ,4 ,9, 9 ,0},
    {"softwood"     ,0 ,0 ,5 ,4, 9 ,0},
    {"steel"        ,0 ,0 ,8 ,3, 3 ,0},
    {"stone"        ,0 ,0 ,8 ,4, 2 ,9},
    {"sulfur"       ,0 ,0 ,0 ,7, 7 ,0},
    {"tin"          ,0 ,0 ,3 ,4, 5 ,0},
    {"titanium"     ,0 ,0 ,9 ,3, 2 ,0},
    {"vellum"       ,0 ,0 ,0 ,6, 9 ,0},
    {"velvet"       ,0 ,6 ,3 ,8, 9 ,0},//kadife
    {"water"        ,0 ,0 ,0 ,5, 9 ,9},
    {"wax"          ,0 ,0 ,0 ,6, 9 ,0},//balmumu
    {"wheat"        ,8 ,0 ,0 ,6, 9 ,0},//bugday
    {"wood"         ,0 ,0 ,4 ,6, 9 ,0},
    {"wool"         ,1 ,7 ,3 ,8, 9 ,0},
    {NULL           ,0 ,0 ,0 ,0, 0 ,0}
};
