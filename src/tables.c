...
{
  { "None", "None",0,0,NULL },
  { "Yarg��lar",	"t�ze",	511,512,NULL	},
  { "�stilac�lar",	"istila",	561,568,NULL	},
  { "Karma�an�n efendileri", 		"kaos",	552,554,NULL	},
  { "B�y� sanatlar�n�n efendileri", 	"t�ls�m",	531,530,NULL 	},
  { "D�v�� sanatlar�n�n efendileri",	"�fke",	541,548,NULL 	},
  { "��valyeler", 		"��valye",	522,524,NULL 	},
  { "Ormanlar�n efendileri", 		"aslan",		502,504,NULL 	},
  { "T�ccarlar",	"t�ccar",	571,573,NULL 	}
};
...
{
    // ISIM,
    // YEMEK ICIN UYGUN MU (0 uygun de�il, 9 cok uygun ve doyurucu),
    // TEKSTIL URUNLERI ICIN UYGUN MU, (0 uygun de�il, 9 cok uygun ve uzun omurlu),
    // ARMOR ICIN UYGUN MU, (0 uygun de�il, 9 cok uygun ve uzun omurlu, dayanikli),
    // WEAPON ICIN UYGUN MU, (0 uygun de�il, 9 cok uygun ve uzun omurlu, dayanikli),
    // SESSIZ MI (0 cok gurultulu , 9 cok sessiz),
    // YUZER MI (0 h�zl� batar, 9 hic batmaz)
    // PORTAL ICIN UYGUN MU (0 uygun de�il, 9 cok uygun),
    // ozgul agirlik. 1 cm3'�n agirligi. gr cinsinden.
    ...
    {"ash",        "k�l",          /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE,  /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/50},
    ...
    {"bearskin",   "ay�derisi",      /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/TRUE,  /*ZIRH*/TRUE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/TRUE,  /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/200},
    ...
    {"brass",      "pirin�",         /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/9, /*ESKIME*/450},
    ...
    {"cashmire",   "ka�mir",         /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/TRUE,  /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/TRUE,  /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/120},
    ...
    {"coal",       "k�m�r",          /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/FALSE,  /*OAGIRLIK*/1, /*ESKIME*/100},
    {"copper",     "bak�r",          /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/9, /*ESKIME*/450},
    ...
    {"emerald",    "z�mr�t",         /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/3, /*ESKIME*/400},
    ...
    {"feather",    "t�y",            /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/TRUE,  /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/50},
    {"felt",       "ke�e",           /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/TRUE,  /*ZIRH*/TRUE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/120},
    {"fish",       "bal�k",          /*YEMEK*/TRUE,  /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/20},
    {"fishskin",   "bal�kderisi",    /*YEMEK*/TRUE,  /*TASIYICI*/FALSE, /*TEKSTIL*/TRUE,  /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/100},
    ...
    {"flower",     "�i�ek",          /*YEMEK*/TRUE,  /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/2, /*ESKIME*/10},
    {"fur",        "k�rk",           /*YEMEK*/TRUE,  /*TASIYICI*/TRUE,  /*TEKSTIL*/TRUE,  /*ZIRH*/TRUE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/200}, // 30
    {"gem",        "m�cevher",       /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/3, /*ESKIME*/500},
    ...
    {"gold",       "alt�n",          /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/15, /*ESKIME*/550},
    ...
    {"gut",        "ba��rsak",       /*YEMEK*/TRUE,  /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/20},
    {"hair",       "k�l",            /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/TRUE,  /*ZIRH*/FALSE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/80},
    ...
    {"ivory",      "fildi�i",        /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/2, /*ESKIME*/400},
    {"lead",       "kur�un",         /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/11, /*ESKIME*/400},  // 40
    {"leather",    "k�sele",         /*YEMEK*/TRUE,  /*TASIYICI*/TRUE,  /*TEKSTIL*/TRUE,  /*ZIRH*/TRUE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/240},
    ...
    {"nothingness","hi�lik",         /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/0, /*ESKIME*/1000},
    {"oak",        "me�e",           /*YEMEK*/FALSE, /*TASIYICI*/FALSE,  /*TEKSTIL*/FALSE, /*ZIRH*/FALSE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/120},
    ...
    {"oil",        "ya�",            /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/20},
    ...
    {"paper",      "ka��t",          /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/TRUE,  /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/60},
    ...
    {"parchment",  "tir�e",          /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE,  /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/60},
    ...
    {"sandstone",  "kumta��",        /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/2, /*ESKIME*/40},
    ...
    {"silver",     "g�m��",          /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/10, /*ESKIME*/500},
    ...
    {"snakeskin",  "y�landerisi",    /*YEMEK*/TRUE,  /*TASIYICI*/TRUE,  /*TEKSTIL*/TRUE,  /*ZIRH*/TRUE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/350},
    {"softwood",   "yumu�aktahta",   /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/200},
    {"steel",      "�elik",          /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/8, /*ESKIME*/600}, // 70
    {"stone",      "ta�",            /*YEMEK*/FALSE, /*TASIYICI*/TRUE,  /*TEKSTIL*/FALSE, /*ZIRH*/TRUE,  /*SILAH*/TRUE,  /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/3, /*ESKIME*/400},
    //{"sulfur",     "s�lf�r",         /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/240},
    ...
    {"vellum",     "tir�e",          /*YEMEK*/FALSE, /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/TRUE,  /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/60},
    ...
    {"wheat",      "bu�day",         /*YEMEK*/TRUE,  /*TASIYICI*/FALSE, /*TEKSTIL*/FALSE, /*ZIRH*/FALSE, /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/5},
    ...
    {"wool",       "y�n",            /*YEMEK*/TRUE,  /*TASIYICI*/TRUE,  /*TEKSTIL*/TRUE,  /*ZIRH*/TRUE,  /*SILAH*/FALSE, /*IKSIR*/FALSE, /*PARSOMEN*/FALSE, /*SESSIZ*/FALSE, /*YUZER*/TRUE,  /*OAGIRLIK*/1, /*ESKIME*/240},
